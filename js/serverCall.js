...
function langChange(init) {
    ...
    /*(localStorage.getItem('gps') === 'PL') ? flags[0].classList.add('current') : flags[1].classList.add('current')*/flags[1].classList.remove('current');flags[0].classList.add('current');
